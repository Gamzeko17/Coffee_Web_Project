        ...
        <tr>
            ...
            <td width="430" heigth="400" valign="top">
                ...
                <div class="card" style="height: 404px;background-color: papayawhip;margin-top: 1px;">
                    <table width="435px" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="30"  style="color: #FFFFFF;background-color: #8B4513;font-size: 24px;font-style: italic;font-family: auto;text-align: center;">&nbsp;Üyelik Alanı</td>
                        </tr>
                        <tr>
                            <td height="30" align="left" style="font-size: 24px;font-family: initial;font-style: initial;text-align: center;">Merhaba <?php echo $UyeninAdiSoyadi; ?></td>
                        </tr>
                        <tr>
                            <td height="30" align="rigth"><a href="cikis.php" style="font-size:21px;font-style=italic;font-weight:400;color:brown;margin-left:16px">Çıkış Yap</a></td>
                        </tr>
                    </table>   
                    ...
                    <div class="card" style="height: 404px;background-color: papayawhip;margin-top: 1px;">
                        <form action="uyegiris.php" method="post">
                            <table width="430" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="3" height="30" style="color: #FFFFFF;background-color: #8B4513;font-size: 26px;font-style: italic;font-family: auto;font-weight: bold;text-align: center; ">&nbsp;Üyelik Alanı</td>
                                </tr>
                                <tr>
                                    <td width="100" height="30" style="font-size: 23px;font-style: italic;font-family: inherit;">&nbsp;Kullanıcı Adı</td>
                                    <td width="10" height="30">:</td>
                                    <td width="190" height="30"><input type="text" name="kullaniciadi" style="width:98%"></td>
                                </tr>
                                <tr>
                                    <td width="100" height="30" style="font-size: 23px;font-style: italic;font-family: inherit;">&nbsp;Şifre</td>
                                    <td width="10" height="30">:</td>
                                    <td width="190" height="30"><input type="password" name="password" style="width:98%"></td>
                                </tr>
                                <tr>
                                    <td width="100" height="30">&nbsp;</td>
                                    <td width="10" height="30">&nbsp;</td>
                                    <td width="190" height="30" align="right"><input type="submit" value="Giriş Yap" style="width: 141px;height: 39px;border-radius: 40px;font-size: 19px;font-style: italic;font-weight: 400;background-color: tan;margin-top: 15px;"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" height="30" align="right"><p style="margin-top:10px;"><a href="uyeol.php" style="color: black;margin-right: 22px;text-decoration: revert;font-size: 18px;font-style: italic;">Yeni Üye Ol</a></p></td>
                                </tr>
